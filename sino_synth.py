...
model_id = 'aru' if n_args < 2 else sys.argv[1] 

# The loss function, 'L1' or 'SSIML1'
loss_name = 'SSIML1' if n_args < 3 else sys.argv[2] 
...
# seed
seed = 8051 if n_args < 6 else int(sys.argv[5])
# main directory
main_dir = 'D:/Data/MIDRC/' if n_args < 7 else sys.argv[6]
